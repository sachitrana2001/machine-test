...
const Vehicles = () => {
  ...
  const API_URL = "https://erp.sugamyatra.up.in/api/fabricator/getall";
  const COL_DEF = [
    {
      field: "id",
      headerName: "Sr. No",
    ...
    },
    {
      ...
      headerName: "Fabricator Name",
      headerClassName: "super-app-theme--header",
      width: 150,
    },
    {
      field: "fabricatorCode",
      headerName: "Fabricator Code",
      headerClassName: "super-app-theme--header",
      //   type: 'number',
      width: 110,
      editable: true,
  ...
  return (
    <div className="vehicle-wrap">
      <div className="head">
        <div className="heading">Fabricator</div>
