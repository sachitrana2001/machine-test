...
const Vehicles = () => {
    ...
    const API_URL = "https://erp.sugamyatra.up.in/api/vehicleTrims/getall"
    const COL_DEF = [
    ...
    return (
        <div className="vehicle-wrap">
            <div className="head">
                <div className="heading">Trim</div>
                <div className="head-btns">
                    <button className="button">Export</button>
                    <button className="button" onClick={onAddVechicle}>+ Add Trim</button>
                ...
                <div className="action-container d-h-center" onClick={() => setIsAction(!isAction)}>
                    ...
                    {isAction && <div className="action-option">
                        ...
                        <div className="option-section d-h-between">
                            <div className="heading-400-12">Print Bus Service Type Labels</div>
