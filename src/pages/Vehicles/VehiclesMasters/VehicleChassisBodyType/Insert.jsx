...
const AddVehicles = () => {
  ...
  const formData = [
    {
      left: {
        title: "Add Chassis Body Type (En)",
        para: "Add Chassis Body Type Detail Here",
      },
      right: [
        {
          block_type: "field-type-one",
          name: "chassisBodyTypeName",
          input_type: "text",
          labelName: "Chassis Body Type Name",
          placeholder: "Enter Chassis Body Type Name",
        },
        {
          block_type: "field-type-one",
          name: "chassisBodyTypeShortName",
          input_type: "text",
          labelName: "Chassis Body Type Short Name",
          placeholder: "Enter Chassis Body Type Short Name",
        },
      ],
    },
    {
      left: {
        title: "Add Chassis Body Type (Hi)",
        para: "Add Chassis Body Type Detail Here",
      },
      right: [
        {
