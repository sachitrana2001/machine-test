  ...
  const formData = [
    {
      left: {
        ...
        para: "Add Fabricator Detail Here",
      },
      right: [
        {
          ...
          name: "fabricatorName",
          input_type: "text",
          labelName: "Add Fabricator",
          placeholder: "Enter Fabricator Short Name",
        },
        {
          block_type: "field-type-one",
          name: "fabricatorShortName",
          input_type: "text",
          labelName: "Fabricator Short Name",
          placeholder: "Fabricator Short Name",
        },
      ],
    },
    {
                  ...
                  <div className="add-v-form-right-section">
                    <div className="add-v-form-section">
                      ...
                      <div className="troo-input-field">
                        <label className="troo-label c-black">
                          Fabricator Type
                        </label>
                        <RadioGroup
