...
const Vehicles = () => {
  ...
  const API_URL = "https://erp.sugamyatra.up.in/api/vehicleFuelTypes/getall";
  const COL_DEF = [
    {
      field: "id",
      headerName: "Sr. No",
    ...
    {
      field: "vehicleFuelTypeName",
      headerName: "vehicleFuelTypeName",
      headerClassName: "super-app-theme--header",
      width: 150,
    },
    {
      field: "vehicleFuelTypeCode",
      headerName: "vehicleFuelTypeCode",
      headerClassName: "super-app-theme--header",
      width: 150,
    },
    {
  ...
  const onAddVechicle = () => {
    navigate("/vehicle-fabricator-insert");
  };
  return (
    <div className="vehicle-wrap">
      <div className="head">
        <div className="heading">Fuel Types</div>
          ...
          {isAction && (
            <div className="action-option">
              <div className="option-section d-h-between border-bottom-gray">
                <div className="heading-400-12">Update Fabricator</div>
                <div>{editIcon({ width: 12, height: 12 })}</div>
              </div>
              <div className="option-section d-h-between">
                <div className="heading-400-12">Print Fabricator Labels</div>
