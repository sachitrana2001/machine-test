...
// import { archiveIcon, attachIcon, dotIcon, editIcon, geareIcon, lightBlubIcon, printIcon, userAddIcon, userRemoveIcon } from "@helpers/Icons";
import "../../List.css";
...
const Vehicles = () => {
    ...
    const API_URL = "https://erp.sugamyatra.up.in/api/modelEuros/getall"
    const COL_DEF = [
        { field: 'id', headerName: 'Sr. No', headerClassName: 'super-app-theme--header', width: 90 },
        {
            field: 'modelEuroTypeName',
            headerName: 'Model Euro Type Name',
            headerClassName: 'super-app-theme--header',
            width: 150,
        },
        {
            field: 'modelEuroTypeCode',
            headerName: 'Model Euro Type Code',
            headerClassName: 'super-app-theme--header',
            //   type: 'number',
            width: 110,
            editable: true,
    ...
    const onAddVechicle = () => {
        navigate('/vehicle-model-euro-insert')
    }
    return (
        <div className="vehicle-wrap">
            <div className="head">
                <div className="heading">Model Euros</div>
                <div className="head-btns">
                    <button className="button">Export</button>Model Euros<button className="button dot">
            ...
            <div className="action-main d-h-between">
                <div className="action-container d-h-center" onClick={() => setIsAction(!isAction)}>
                ...
                <div>
                    <div className="d-h-center" style={{ gap: "4px" }}>
                        <div className="action-div d-h-center">{geareIcon({ width: 15, height: 18 })}</div>
                        <div className="action-div d-h-center">{lightBlubIcon({ width: 15, height: 18 })}</div>
                    </div>
                </div>
            </div>
            <RDataGrid
