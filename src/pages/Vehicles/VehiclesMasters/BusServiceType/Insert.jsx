...
const AddVehicles = () => {
  ...
  const formData = [
    {
      left: {
        title: "Add Bus Service Type (En)",
        para: "Add Bus Service Type Detail Here",
      },
      right: [
        {
          block_type: "field-type-one",
          name: "busServiceTypeName",
          input_type: "text",
          labelName: "Bus Service Type Name",
          placeholder: "Enter Bus Service Type Name",
        },
        {
          block_type: "field-type-one",
