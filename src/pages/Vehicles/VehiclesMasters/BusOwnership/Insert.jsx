  ...
  const formData = [
    {
      left: {
        ...
        para: "Add Bus Ownership Detail Here",
      },
      right: [
        {
          block_type: "field-type-five",
          name1: "busOwnershipName",
          input_type1: "text",
          labelName1: "Bus Ownership Name",
          placeholder1: "Enter Bus Ownership Name",
          name2: "busOwnershipShortName",
          input_type2: "text",
          labelName2: "Bus Ownership Short Name",
          placeholder2: "Enter Bus Ownership Short Name",
