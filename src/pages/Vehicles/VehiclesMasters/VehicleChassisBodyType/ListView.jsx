...
import { archiveIcon, attachIcon, dotIcon, editIcon, geareIcon, lightBlubIcon, printIcon, rightArrowIcon, userAddIcon, userRemoveIcon } from "@/assets/Icons";
import "../../List.css";
...
const Vehicles = () => {
    ...
    const API_URL = "https://erp.sugamyatra.up.in/api/vehicleChassisTypes/getall"
    const COL_DEF = [
        ...
        {
            field: 'chassisTypeCode',
            headerName: 'Chassis Type Code',
            headerClassName: 'super-app-theme--header',
            //   type: 'number',
            width: 110,
            editable: true,
    ...
    const onAddVechicle = () => {
        navigate('/chassis-body-type-insert')
    }
    return (
        <div className="vehicle-wrap">
            <div className="head">
                <div className="heading">Chassis Type</div>
                <div className="head-btns">
                    <button className="button">Export</button>
                    <button className="button" onClick={onAddVechicle}>+ Add Chassis Type</button>
                ...
                <div className="action-container d-h-center" onClick={() => setIsAction(!isAction)}>
                    ...
                    {isAction && <div className="action-option">
                        <div className="option-section d-h-between border-bottom-gray">
                            Chassis Type                            <div>{editIcon({ width: 12, height: 12 })}</div>
                        </div>
                        <div className="option-section d-h-between">
                            <div className="heading-400-12">Print Chassis Type Labels</div>
